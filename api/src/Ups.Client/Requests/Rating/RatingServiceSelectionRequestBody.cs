...
{
    public class RatingServiceSelectionRequestBody
    {
        [XmlElement(ElementName = Constants.DtoNames.RatingServiceSelectionRequestBodyNames.RequestAction)]
        public string RequestAction { get; set; }
        [XmlElement(ElementName = Constants.DtoNames.RatingServiceSelectionRequestBodyNames.RequestOption)]
