...
namespace Ups.Client.Responses.Ship
{
    ...
    {
        [XmlElement(ElementName = Constants.DtoNames.ShipmentConfirmResponseNames.ShipmentIdentificationNumber)]
        public string ShipmentIdentificationNumber { get; set; }
        [XmlElement(ElementName = Constants.DtoNames.ShipmentConfirmResponseNames.MIDualReturnShipmentKey)]
        public string MIDualReturnShipmentKey { get; set; }
        [XmlElement(ElementName = Constants.DtoNames.ShipmentConfirmResponseNames.Response)]
