...
{
    public class LocatorSearchResults
    {
        [XmlElement(ElementName = Constants.DtoNames.LocatorSearchResultsNames.GeocodeCandidate)]
        public LocatorGeocodeCandidate GeocodeCandidate { get; set; }
        [XmlElement(ElementName = Constants.DtoNames.LocatorSearchResultsNames.Disclaimer)]
