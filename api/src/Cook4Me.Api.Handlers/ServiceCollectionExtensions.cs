...
namespace Cook4Me.Api.Handlers
{
    public static class ServiceCollectionExtensions
    {
        public static IServiceCollection AddHandlers(this IServiceCollection serviceCollection)
        {
            ...
            var orderCommandsHandler = new OrderCommandsHandler(provider.GetService<IOrderRepository>(), provider.GetService<IProductRepository>(), bus, provider.GetService<IOrderPriceCalculatorHelper>(), provider.GetService<IDiscountPriceCalculatorHelper>(), provider.GetService<IDiscountRepository>());
            ...
            bus.RegisterHandler<UpdateProductCommand>(productCommandHandler.Handle);
            bus.RegisterHandler<AddProductCommand>(productCommandHandler.Handle);
            bus.RegisterHandler<RemoveProductCommand>(productCommandHandler.Handle);
            ...
            bus.RegisterHandler<UpdateServiceCommand>(serviceCommandHandler.Handle);
            bus.RegisterHandler<RemoveServiceCommand>(serviceCommandHandler.Handle);
            ...
            bus.RegisterHandler<OrderCanceledEvent>(notificationEventsHandler.Handle);
