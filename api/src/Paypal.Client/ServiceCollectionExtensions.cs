...
namespace Dhl.Client
{
    ...
    {
        public static IServiceCollection AddPaypalClient(this IServiceCollection serviceCollection)
        {
            ...
            serviceCollection.AddTransient<IPaypalOpenidClient, PaypalOpenidClient>();
