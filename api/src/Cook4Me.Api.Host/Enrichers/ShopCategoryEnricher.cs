...
{
    public interface IShopCategoryEnricher
    {
        void Enrich(IHalResponseBuilder halResponseBuilder, ShopCategoryAggregate category);
    }

    internal class ShopCategoryEnricher : IShopCategoryEnricher
    {
        private readonly IResponseBuilder _responseBuilder;

        public ShopCategoryEnricher(IResponseBuilder responseBuilder)
        {
