...
namespace Cook4Me.Api.Host.Enrichers
{
    ...
    {
        void Enrich(IHalResponseBuilder halResponseBuilder, NotificationAggregate notification);
    }

    internal class NotificationEnricher : INotificationEnricher
    {
        private readonly IResponseBuilder _responseBuilder;

        public NotificationEnricher(IResponseBuilder responseBuilder)
        {
