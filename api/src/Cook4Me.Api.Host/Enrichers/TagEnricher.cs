...
namespace Cook4Me.Api.Host.Enrichers
{
    ...
    {
        void Enrich(IHalResponseBuilder halResponseBuilder, TagAggregate tag);
    }

    internal class TagEnricher : ITagEnricher
    {
        private readonly IResponseBuilder _responseBuilder;

        public TagEnricher(IResponseBuilder responseBuilder)
        {
