...
{
    public interface IServiceCommentEnricher
    {
        void Enrich(IHalResponseBuilder halResponseBuilder, ServiceComment serviceComment, string serviceId);
    }

    internal class ServiceCommentEnricher : IServiceCommentEnricher
    {
        private readonly IResponseBuilder _responseBuilder;

        public ServiceCommentEnricher(IResponseBuilder responseBuilder)
        {
