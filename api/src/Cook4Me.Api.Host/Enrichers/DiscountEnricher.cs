...
{
    public interface IDiscountEnricher
    {
        void Enrich(IHalResponseBuilder halResponseBuilder, DiscountAggregate discountAggregate);
    }

    internal class DiscountEnricher : IDiscountEnricher
    {
        private readonly IResponseBuilder _responseBuilder;

        public DiscountEnricher(IResponseBuilder responseBuilder)
        {
