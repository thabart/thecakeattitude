...
{
    public interface IShopCommentEnricher
    {
        void Enrich(IHalResponseBuilder halResponseBuilder, ShopComment shopComment, string shopId);
    }

    internal class ShopCommentEnricher : IShopCommentEnricher
    {
        private readonly IResponseBuilder _responseBuilder;

        public ShopCommentEnricher(IResponseBuilder responseBuilder)
        {
