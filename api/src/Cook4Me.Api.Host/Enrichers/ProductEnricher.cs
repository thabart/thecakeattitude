...
namespace Cook4Me.Api.Host.Enrichers
{
    ...
    {
        void Enrich(IHalResponseBuilder halResponseBuilder, ProductAggregate product);
    }
    
    internal class ProductEnricher : IProductEnricher
    {
        private readonly IResponseBuilder _responseBuilder;

        public ProductEnricher(IResponseBuilder responseBuilder)
        {
