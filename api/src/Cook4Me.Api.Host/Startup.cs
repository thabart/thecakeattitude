...
namespace Cook4Me.Api.Host
{
    public class Startup
    {
        ...
        private static void RegisterDependencies(IServiceCollection services, IConfigurationRoot configuration)
        {
            ...
            services.AddTransient<IConfirmOrderReceptionValidator, ConfirmOrderReceptionValidator>();
            ...
            services.AddTransient<ISearchFeedItemsOperation, SearchFeedItemsOperation>();
            services.AddTransient<IGetTagOperation, GetTagOperation>();
            ...
            services.AddTransient<IUpdateProductOperation, UpdateProductOperation>();
            ...
            services.AddTransient<IGetAllFeedItemsOperation, GetAllFeedItemsOperation>();
            ...
            services.AddTransient<IUpdateServiceOperation, UpdateServiceOperation>();
            ...
            services.AddTransient<IDeleteProductOperation, DeleteProductOperation>();
            services.AddTransient<IDeleteShopOperation, DeleteShopOperation>();
            services.AddTransient<IDeleteServiceOperation, DeleteServiceOperation>();
            ...
            services.AddTransient<IConfirmOrderReceptionOperation, ConfirmOrderReceptionOperation>();
