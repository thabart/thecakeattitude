...
{
    public interface IGetMineShopsOperation
    {
        Task<IActionResult> Execute(string subject);
    }

    internal class GetMineShopsOperation : IGetMineShopsOperation
    {
        private readonly IShopRepository _repository;
        private readonly IHalResponseBuilder _halResponseBuilder;
        private readonly IShopEnricher _shopEnricher;

        public GetMineShopsOperation(IShopRepository repository, IHalResponseBuilder halResponseBuilder, IShopEnricher shopEnricher)
        {
