...
{
    public interface IAddShopCommentOperation
    {
        Task<IActionResult> Execute(JObject jObj, string subject);
    }

    public class AddShopCommentOperation : IAddShopCommentOperation
    {
        ...
        public AddShopCommentOperation(IRequestBuilder requestBuilder, IAddCommentValidator addCommentValidator,
        ...
        public async Task<IActionResult> Execute(JObject jObj, string subject)
        {
            ...
            var command = _requestBuilder.GetAddShopComment(jObj);
