...
{
    public interface ISearchParcelShopLocationsOperation
    {
        Task<IActionResult> Execute(JObject jObj);
    }

    internal class SearchParcelShopLocationsOperation : ISearchParcelShopLocationsOperation
    {
        private readonly IRequestBuilder _requestBuilder;
        private readonly IDhlClient _dhlClient;
        private readonly IResponseBuilder _responseBuilder;

        public SearchParcelShopLocationsOperation(IRequestBuilder requestBuilder, IDhlClient dhlClient, IResponseBuilder responseBuilder)
        {
