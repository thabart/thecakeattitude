var AddOfferModal = function() {};
AddOfferModal.prototype = $.extend({}, BaseModal.prototype, {
  init: function() {
    var self = this;
    var title = $.i18n('addOfferModalTitle'),
      addAnnounce = $.i18n('addOffer'),
      description = $.i18n('description'),
      address = $.i18n('address'),
      error = $.i18n('error');
    self.descriptionTab = new AddOfferModalDescriptionTab();
    self.addressTab = new AddOfferModalAddressTab();
