...
class App extends Component {
    ...
    componentWillMount() {
        ...
        securedProxy.on('orderConfirmed', function(message) {
            AppDispatcher.dispatch({
                actionName: Constants.events.ORDER_CONFIRMED_ARRIVED,
                data: message
            });
        });
        ...
        securedProxy.on('orderLabelPurchased', function(message) {
            AppDispatcher.dispatch({
                actionName: Constants.events.ORDER_LABEL_PURCHASED_ARRIVED,
                data: message
            });
        });
        ...
        return (
            <Router history={history}>
              <div>
                ...
                <Route path="/shopcategories/:id" component={ShopCategories} />
