                        ...
                        <Nav className="mr-auto" navbar>
                            <NavItem>
                                <NavLink to="/home" className="nav-link"
                                         activeClassName="active-menu-item">Map</NavLink>
                            </NavItem>
                            <NavItem>
                                <NavLink to="/sellers" className="nav-link"
                                         activeClassName="active-menu-item">Sellers</NavLink>
                            </NavItem>
                            {
                                (this.state.isLoggedIn) ? <NavItem><NavLink to="/addshop" className="nav-link"
                                                                            activeClassName="active-menu-item">Add
                                    shop</NavLink></NavItem> : ''
                            }
                        </Nav>
                        <Nav className={(this.state.isConnectHidden ? 'hidden' : 'ml-auto')} navbar>
                            {
                                (!this.state.isLoggedIn) ? <NavItem><a href="#" className="nav-link" onClick={() => {
                                    this.toggle('isAuthenticateOpened');
                                }}>Connect</a></NavItem> : ''
                            }
                            {
                                (this.state.isLoggedIn) ?
                                    <NavDropdown isOpen={this.state.isAccountOpened} toggle={() => {
                                        this.toggle('isAccountOpened');
                                    }}>
                                        <DropdownToggle nav caret>Welcome
                                            <strong>{this.state.user.name}</strong></DropdownToggle>
                                        <DropdownMenu>
