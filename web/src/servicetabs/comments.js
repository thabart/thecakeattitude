...
class Comments extends Component {
  ...
  removeComment() {
    ...
    ShopServices.removeComment(this.props.service.id, this.state.currentComment).then(function() {
  ...
  refreshComments() {
    ...
    ShopServices.searchComments(this.props.service.id, searchCommentsJson).then(function(obj) {
  ...
  addComment() {
    ...
    var json = {
      ...
      service_id: self.props.service.id
    };
    ShopServices.addComment(json).then(function(e) {
      self.setState({
        isAddingComment: false
      });
