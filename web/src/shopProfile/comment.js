...
class Comment extends Component {
  ...
  render() {
    return (<CommentLst ref="comments" className="col-md-6" removeCommentCallback={this.removeCommentCallback} searchCommentsCallback={this.searchCommentsCallback} addCommentCallback={this.addCommentCallback} />);
  }
  componentWillMount() {
